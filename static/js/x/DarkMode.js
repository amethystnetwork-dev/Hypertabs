/*
    Dark Mode extension for NotGoogle by luphoria.
...
Page.register({
  ...
  Info: "Dark Mode extension for NotGoogle by luphoria.",
  Description:
    "This extension can toggle a dark mode on pages viewed via NotGoogle.",
  page: "DarkMode",
  name: "DarkMode",
});
